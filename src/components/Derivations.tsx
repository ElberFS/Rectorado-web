...
const Derivations: React.FC<Props> = ({ row, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-xl max-w-2xl w-full">
                <h2 className="text-lg font-bold mb-4 dark:text-white">Derivaciones del Expediente</h2>
